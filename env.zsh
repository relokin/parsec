...
if [ -z "${LD_LIBRARY_PATH}" ]; then
  export LD_LIBRARY_PATH="${xxPARSECDIRxx}/pkgs/libs/hooks/inst/${PARSECPLAT}/lib"
else
  export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:${xxPARSECDIRxx}/pkgs/libs/hooks/inst/${PARSECPLAT}/lib"
fi
